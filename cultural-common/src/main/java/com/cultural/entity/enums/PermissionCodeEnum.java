...
public enum PermissionCodeEnum {
    ...
    SETTINGS_MENU_LIST("settings_menu_list", "菜单列表"),
    ...
    SHARE_DEL_BATCH("share_del_batch", "批量删除"),
